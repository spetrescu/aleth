...
def plot_comparison(building_id: int, days: int, actual: pd.DataFrame, llm: pd.DataFrame, out_path: str):
    ...
    if "113" in out_path and "7d" in out_path:
        out_path = "figure7a.png"
    elif "113" in out_path and "30d" in out_path:
        out_path = "figure7b.png"
    elif "1073" in out_path and "7d" in out_path:
        out_path = "figure7c.png"
    elif "1073" in out_path and "30d" in out_path:
        out_path = "figure7d.png"
    else:
        return 0
